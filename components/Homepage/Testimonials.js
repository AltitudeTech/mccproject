...
<Fragment>
    ...
    <div className="testimonials">
        <div className="container"> 
            <h2 className="w3ls_para">Endorsements</h2>
            ...
            <ul id="flexiselDemo1">	
                ...
                <div className="agile_testimonials_grid">
                    <div className="agile_testimonials_grid1">
                    <p>I have no doubt, this is a wonderful tool. I am amazed by the speed of delivery of MCC report, which is clear and easy to understand. I appreciate the fact the MCC report is also accompanied by a “practical workbook”. </p>
                    <div className="w3_agile_testimonials_grid">
                        <div className="w3_agile_testimonials_grid_left">
                        {/* <img src="/static/images/3.png" alt=" " className="img-responsive" /> */}
                        </div>
                        <div className="w3_agile_testimonials_grid_right">
                        <h4>Winsten Carl</h4>
                        <h5>Lawyer</h5>
                ...
                <script type="text/javascript" src="/static/js/test4.js">
