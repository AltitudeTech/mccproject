...
<Fragment>
{/* <div style={{borderBottom:'1px solid #000', background : '#f5f5f5', paddingBottom: '30px', paddingTop: '30px'}} > */}
<div style={{borderBottom:'1px solid #000', background : 'black', paddingBottom: '30px', paddingTop: '30px'}} >
